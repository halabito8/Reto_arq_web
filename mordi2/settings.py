"""
Django settings for mordi2 project.
...
SECRET_KEY = 'django-insecure-mepqbg=enfus%58k(@n%t!5=qympv)=&gvyb=!u6+@1-q=hul)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.68.137','localhost','127.0.0.1','warm-retreat-82659.herokuapp.com']
...
WSGI_APPLICATION = 'mordi2.wsgi.application'
